...
Para enviar uma NFSe deve ser criado um objeto do tipo relacionado (`EvandroSwk\Plugnotas\Nfse`), o qual é composto de vários outros objetos agrupados dentro de seu namespace.
...
A classe `EvandroSwk\Plugnotas\Builders\NfseBuilder` é uma classe auxiliar que permite você criar de forma fácil um objeto `EvandroSwk\Plugnotas\Nfse`.
...
Para consultar uma NFSe é necessário criar um objeto do tipo `EvandroSwk\Plugnotas\Configuration`, setar ele num novo objeto `EvandroSwk\Plugnotas\Nfse` utilizando o método `setConfiguration`.
...
Da mesma forma que a consulta o download do PDF da Nfse necessita de um objeto do tipo `EvandroSwk\Plugnotas\Configuration`, o qual deve ser setado num novo objeto `EvandroSwk\Plugnotas\Nfse` utilizando o método `setConfiguration`.
...
Da mesma forma que a consulta e o download do PDF da Nfse é necessário de um objeto do tipo `EvandroSwk\Plugnotas\Configuration`, o qual deve ser setado num novo objeto `EvandroSwk\Plugnotas\Nfse` utilizando o método `setConfiguration`.
